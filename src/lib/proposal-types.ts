  ...
  video: {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        options: TIERS,
        hint: "Where it appears on the videos page",
      },
      {
        key: "source",
  ...
  document: {
    ...
    fields: [
      ...
      },
      {
        ...
        kind: "text",
        required: true,
        hint: "e.g. Court Filing, Police Report",
      },
